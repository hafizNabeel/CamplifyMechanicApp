    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, alignItems: 'center', marginHorizontal: "5%" ,}}>
                ...
                <View style={{ height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly', marginVertical: 2, marginHorizontal: "5%",shadowOffset: { width: 5, height: 5, },
                              shadowColor: '#003171',
                              shadowOpacity: 0.3, }}>
